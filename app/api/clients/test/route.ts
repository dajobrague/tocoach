...
export async function GET(request: NextRequest) {
    try {
        ...
        console.log('[Clients Test] Supabase URL:', process.env.NEXT_PUBLIC_SUPABASE_URL);
        ...
        if (tablesError) {
            console.error('[Clients Test] Error connecting to Supabase:', tablesError);
        ...
        console.log('[Clients Test] Clients data:', JSON.stringify(allClients, null, 2));
