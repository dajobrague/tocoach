        ...
        <div className="flex h-full w-full items-center justify-center min-h-screen p-4">
            <div className="w-full max-w-md">
                <div className="flex flex-col items-center pb-8">
                    ...
                    <h2 className="text-2xl font-heading font-semibold mb-2">Crea tu cuenta</h2>
                    <p className="text-default-500 font-body text-center">Únete a TopCoach y empieza a construir tu negocio de coaching</p>
                </div>
                ...
                <div className="rounded-large bg-content1 shadow-small flex w-full flex-col gap-6 px-8 py-8">
                    ...
                    <p className="text-small text-center font-body">
                        ...
                        <Link href="/trainer/login" size="sm" className="font-body">
                            Iniciar sesión
                        </Link>
                    </p>
                </div>
