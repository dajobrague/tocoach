...
export default function CalendarTab({ clientId }: CalendarTabProps) {
    ...
    const selectedDateFormatted = selectedDate ? new Date(selectedDate + 'T12:00:00').toLocaleDateString('es-ES', {
        weekday: 'long',
        year: 'numeric',
        month: 'long',
        day: 'numeric'
                            ...
                            return (
                                <div key={i} className="aspect-square relative">
                                    <Card
                                        ...
                                        className={`w-full h-full ${hasData
                                            ? isToday
                                    ...
                                    >
                                        <CardBody className="p-2 flex flex-col items-start justify-start h-full">
                                            {/* Day number */}
                                            <span className={`text-sm font-bold mb-1 ${hasData
                                            ...
                                            {hasData && data && (
                                                <div className="flex flex-wrap gap-1 mt-auto">
                                                    {data.workout && (
                                                        <div className="bg-blue-100 p-1 rounded" title="Entrenamiento">
                                                            <Icon icon="solar:dumbbell-bold" className="text-blue-600" width={18} />
                                                        </div>
                                                    )}
                                                    {data.cardio && (
                                                        <div className="bg-red-100 p-1 rounded" title="Cardio">
                                                            <Icon icon="solar:heart-pulse-bold" className="text-red-600" width={18} />
                                                        </div>
                                                    )}
                                                    {data.meals && (
                                                        <div className="bg-orange-100 p-1 rounded" title="Nutrición">
                                                            <Icon icon="solar:leaf-bold" className="text-orange-600" width={18} />
                                                        </div>
                                                    )}
                                                    {data.checkIn && (
                                                        <div className="bg-purple-100 p-1 rounded" title="Check-in">
                                                            <Icon icon="solar:clipboard-list-bold" className="text-purple-600" width={18} />
                                                        </div>
                                                    )}
                                                    {data.photos && (
                                                        <div className="bg-pink-100 p-1 rounded" title="Fotos">
                                                            <Icon icon="solar:camera-bold" className="text-pink-600" width={18} />
                                                        </div>
                                                    )}
                                                </div>
                                            )}
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                            <div className="flex items-center gap-2">
                                <div className="bg-blue-100 p-1 rounded">
                                    <Icon icon="solar:dumbbell-bold" className="text-blue-600" width={16} />
                                </div>
                                <span className="text-xs text-gray-600">Entrenamiento</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <div className="bg-red-100 p-1 rounded">
                                    <Icon icon="solar:heart-pulse-bold" className="text-red-600" width={16} />
                                </div>
                                <span className="text-xs text-gray-600">Cardio</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <div className="bg-orange-100 p-1 rounded">
                                    <Icon icon="solar:leaf-bold" className="text-orange-600" width={16} />
                                </div>
                                <span className="text-xs text-gray-600">Nutrición</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <div className="bg-purple-100 p-1 rounded">
                                    <Icon icon="solar:clipboard-list-bold" className="text-purple-600" width={16} />
                                </div>
                                <span className="text-xs text-gray-600">Check-in</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <div className="bg-pink-100 p-1 rounded">
                                    <Icon icon="solar:camera-bold" className="text-pink-600" width={16} />
                                </div>
                    ...
                    <ModalHeader className="flex flex-col gap-1">
                        <div className="flex items-center gap-3">
                            <div className="bg-blue-50 p-2 rounded-lg">
                                <Icon icon="solar:calendar-bold" className="text-blue-600 text-xl" />
                            </div>
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 capitalize">{selectedDateFormatted}</h3>
                                <p className="text-sm text-gray-500 font-normal">Resumen del día</p>
                            </div>
                        </div>
                    </ModalHeader>
                    <ModalBody>
                        {selectedDateData ? (
                                    ...
                                    <Card className="bg-white border border-blue-200">
                                        <CardBody className="p-4">
                                            <div className="flex items-start gap-3">
                                                <div className="bg-blue-50 p-2 rounded-lg">
                                                    <Icon icon="solar:dumbbell-bold" className="text-blue-600" width={24} />
                                                </div>
                                                <div className="flex-1">
                                                    <h4 className="font-bold text-gray-900 mb-1">Entrenamiento</h4>
                                                    <p className="text-sm text-gray-600">{selectedDateData.workout.name}</p>
                                                    <p className="text-xs text-gray-500 mt-1">
                                                        Estado: {selectedDateData.workout.completed ? '✓ Completado' : 'Pendiente'}
                                                    </p>
                                                </div>
                                            </div>
                                        </CardBody>
                                        ...
                                        <CardBody className="p-4">
                                            <div className="flex items-start gap-3">
                                                <div className="bg-red-50 p-2 rounded-lg">
                                                    <Icon icon="solar:heart-pulse-bold" className="text-red-600" width={24} />
                                                </div>
                                                <div className="flex-1">
                                                    <h4 className="font-bold text-gray-900 mb-1">Cardio</h4>
                                                    <p className="text-sm text-gray-600">{selectedDateData.cardio.type}</p>
                                                    <p className="text-xs text-gray-500 mt-1">
                                        ...
                                        <CardBody className="p-4">
                                            <div className="flex items-start gap-3">
                                                <div className="bg-orange-50 p-2 rounded-lg">
                                                    <Icon icon="solar:leaf-bold" className="text-orange-600" width={24} />
                                                </div>
                                                <div className="flex-1">
                                                    <h4 className="font-bold text-gray-900 mb-1">Nutrición</h4>
                                        ...
                                        <CardBody className="p-4">
                                            <div className="flex items-start gap-3">
                                                <div className="bg-purple-50 p-2 rounded-lg">
                                                    <Icon icon="solar:clipboard-list-bold" className="text-purple-600" width={24} />
                                                </div>
                                                <div className="flex-1">
                                                    <h4 className="font-bold text-gray-900 mb-1">Check-in Diario</h4>
                                                    <p className="text-sm text-gray-600">Peso: {selectedDateData.checkIn.weight} kg</p>
                                                    <p className="text-xs text-gray-500 mt-1">{selectedDateData.checkIn.notes}</p>
                                                </div>
                                            </div>
                                        </CardBody>
                                    </Card>
                                        ...
                                        <CardBody className="p-4">
                                            <div className="flex items-start gap-3">
                                                <div className="bg-pink-50 p-2 rounded-lg">
                                                    <Icon icon="solar:camera-bold" className="text-pink-600" width={24} />
                                                </div>
                                                <div className="flex-1">
                                                    <h4 className="font-bold text-gray-900 mb-1">Fotos de Progreso</h4>
                                                    <p className="text-sm text-gray-600">
                            ...
                            <div className="text-center py-12">
                                <div className="bg-gray-100 p-4 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                                    <Icon icon="solar:calendar-linear" className="text-gray-400 text-3xl" />
                                </div>
                                <h3 className="text-lg font-semibold text-gray-900 mb-2">Sin actividad registrada</h3>
