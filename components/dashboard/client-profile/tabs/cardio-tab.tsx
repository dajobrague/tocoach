...
export default function CardioTab({ clientId, clientName }: CardioTabProps) {
  ...
  const confirmDuplicateSession = async () => {
    ...
    try {
      ...
      console.error("[CardioTab] Error duplicating session:", err);
  ...
  const confirmDuplicateExercise = async () => {
    ...
    try {
      ...
      console.error("[CardioTab] Error duplicating exercise:", err);
        ...
        <ModalContent>
          ...
          <ModalBody className="gap-3">
            <p className="text-sm text-gray-500">
              ...
              con su prescripción completa. La copia quedará justo debajo.
            </p>
            <Input
              autoFocus
