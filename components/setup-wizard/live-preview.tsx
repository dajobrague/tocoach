          ...
          >
            ...
            >
              ...
              <header
                ...
                style={{
                  backgroundColor:
                    state.colors?.background?.primary || "#ffffff",
                }}
              >
                <div
                  className={`flex items-center ${state.logo?.position === "center" ? "justify-center" : state.logo?.position === "right" ? "justify-end" : "justify-between"}`}
                >
                  {logoComponent()}
                  {viewMode === "mobile" &&
                    state.logo?.position !== "center" && (
              ...
              >
                ...
                >
                  Entrenamientos personalizados diseñados específicamente para
                  ti
                </p>
                <div
                  className={`flex ${viewMode === "mobile" ? "flex-col" : "flex-row"} gap-3 ${viewMode === "mobile" ? "px-2" : "justify-center"}`}
                >
                  <button
                    className={`font-semibold rounded-xl border-0 cursor-pointer transition-all ${
                      viewMode === "mobile" ? "w-full py-3.5 px-6" : "px-8 py-3"
                    }`}
                    style={{
                      backgroundColor:
                      ...
                      {[
                        {
                          ...
                          title: "Personalizado",
                          desc: "Planes adaptados a ti",
                        },
                        {
                          icon: "solar:chart-2-linear",
                          title: "Seguimiento",
                          desc: "Progreso en tiempo real",
                        },
                        {
                          icon: "solar:medal-star-linear",
                          title: "Resultados",
                          desc: "Garantía de éxito",
                        },
                      ].map((feature, index) => (
                        <Card
                          key={index}
                        ...
                        >
                          <CardBody className="p-5 text-center">
                            <div
                              ...
                              style={{
                                backgroundColor: state.colors.background.accent,
                              }}
                            >
                              <Icon
                                className="text-2xl"
                            ...
                            <h3
                              ...
                              style={{
                                fontFamily:
                                  state.fonts?.heading?.family || "Poppins",
              ...
              <section
                ...
                style={{
                  backgroundColor:
                    state.colors?.background?.accent || "#f3f4f6",
                }}
              >
                <div className="max-w-md mx-auto">
                  ...
                  >
                    <CardBody className="space-y-3 p-0">
                      ...
                      />
                      <button
                        className={`w-full font-semibold rounded-xl border-0 cursor-pointer transition-all ${
                          viewMode === "mobile" ? "py-3.5" : "py-3"
                        }`}
                        style={{
                          backgroundColor:
                            hoveredButton === "form-submit"
                              ? state.colors?.buttons?.primary?.hover ||
                                "#2563eb"
                              : state.colors?.buttons?.primary?.bg || "#3b82f6",
                          color:
                            state.colors?.buttons?.primary?.text || "#ffffff",
              ...
              <footer
                ...
                style={{
                  backgroundColor:
                    state.colors?.background?.secondary || "#f9fafb",
                }}
              >
                <p
                ...
                >
                  © 2024 {state.logo?.text || "Tu Marca"}. Todos los derechos
                  reservados.
                </p>
              </footer>
            </div>
