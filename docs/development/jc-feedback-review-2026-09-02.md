...
JC dijo que _"los encabezados que haya ahora pueden desaparecer"_. El agente eliminó los tabs internos de la página pero conservó el grupo "PLANTILLAS" del sidebar porque también agrupa Gráficas / Check-in / Hábitos. Lectura defendible, pero no es literalmente lo que pidió. Confirmar con JC al enseñárselo.
