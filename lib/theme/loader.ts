...
export function applyCSSVariables(variables: Record<string, string>): void {
    if (typeof document === "undefined") {
        console.warn("[Theme] Cannot apply CSS variables: document is undefined (server-side)");
        return;
    }
    ...
    console.log("[Theme] Verification - CSS variable --color-brand is now:", brandColor);
}
